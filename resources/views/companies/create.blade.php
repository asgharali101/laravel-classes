<x-navigation>
    ...
    <body>
        <x-slot:heading> Create comapny </x-slot:heading>
        <p>TODO</p>
        @if ($errors->any())
            <ul>
        ...
        <form action="/companies/store" method="POST"
            ...
            <h2 class="text-2xl font-bold text-gray-800 text-center">Create New comapny</h2>
            ...
            <div>
                ...
                <x-form-text-area name="description" value="{{ old('description') }}"> {{ old('description') }}
                </x-form-text-area>
