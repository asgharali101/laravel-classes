<x-navigation>
    ...
    <body>
        <x-slot:heading> Create course </x-slot:heading>
        <p>TODO</p>
        ...
        <form action="/courses/store" method="POST" enctype="multipart/form-data"
            ...
            <h2 class="text-2xl font-bold text-gray-800 text-center">Create New course</h2>
            ...
            <div>
                <x-form-label for="image_path">Image</x-form-label>
                <x-form-input type="file" name="image_path" value="{{ old('image_path') }}" />
                <x-form-error name="image_path" />
            </div>

            <div>
                <x-form-label for="body">body</x-form-label>
                <x-form-input name="body" value="{{ old('body') }}" />
